...
| `serena-mcp-tools` | Serena MCP for semantic navigation, symbol-based editing, and low-token-cost refactors. Trigger: ... | [SKILL.md](.agents/skills/serena-mcp-tools/SKILL.md) |
